...
import SparesList from './spares-list-two';
...
class SingleTable extends Component {
	...
	dragulaDecorator(container) {
		//component backing instance è il nodo dom 'reale'
  		//console.log('CBI',container);
  		if (container) {
      		let options = { 
      			mirrorContainer: document.getElementById('img-container')
      		};
      		Dragula([container], options);
    	}
  	}
